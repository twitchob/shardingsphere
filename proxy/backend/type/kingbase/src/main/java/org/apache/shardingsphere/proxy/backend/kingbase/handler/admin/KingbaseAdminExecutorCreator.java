...
package org.apache.shardingsphere.proxy.backend.kingbase.handler.admin;
...
import org.apache.shardingsphere.proxy.backend.kingbase.handler.admin.executor.KingbaseResetVariableAdminExecutor;
import org.apache.shardingsphere.proxy.backend.kingbase.handler.admin.executor.KingbaseSetVariableAdminExecutor;
import org.apache.shardingsphere.proxy.backend.kingbase.handler.admin.executor.KingbaseShowVariableExecutor;
 ...
 */
public final class KingbaseAdminExecutorCreator implements DatabaseAdminExecutorCreator {
    ...
    public Optional<DatabaseAdminExecutor> create(final SQLStatementContext sqlStatementContext) {
        ...
        if (sqlStatement instanceof ShowStatement) {
            return Optional.of(new KingbaseShowVariableExecutor((ShowStatement) sqlStatement));
        }
    ...
    public Optional<DatabaseAdminExecutor> create(final SQLStatementContext sqlStatementContext, final String sql, final String databaseName, final List<Object> parameters) {
        ...
        if (sqlStatement instanceof SetStatement) {
            return Optional.of(new KingbaseSetVariableAdminExecutor((SetStatement) sqlStatement));
        }
        if (sqlStatement instanceof ResetParameterStatement) {
            return Optional.of(new KingbaseResetVariableAdminExecutor((ResetParameterStatement) sqlStatement));
        }
        return Optional.empty();
    }
