...
package org.apache.shardingsphere.proxy.backend.kingbase.handler.admin.executor;
...
public final class KingbaseResetVariableAdminExecutor implements DatabaseAdminExecutor {
    
    private static final String DEFAULT = "DEFAULT";
    
    private final DatabaseType databaseType = TypedSPILoader.getService(DatabaseType.class, "Kingbase");
