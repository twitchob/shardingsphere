...
import org.apache.shardingsphere.proxy.backend.kingbase.handler.admin.executor.variable.charset.KingbaseCharacterSets;
 ...
 */
public final class KingbaseSetCharsetExecutor implements CharsetVariableProvider {
    ...
    public Charset parseCharset(final String variableValue) {
        ...
        try {
            ...
            return "default".equals(result) ? StandardCharsets.UTF_8 : KingbaseCharacterSets.findCharacterSet(result);
