...
public final class KingbasePortalContextRegistry {
    
    private static final KingbasePortalContextRegistry INSTANCE = new KingbasePortalContextRegistry();
     ...
     */
    public static KingbasePortalContextRegistry getInstance() {
        return INSTANCE;
    }
