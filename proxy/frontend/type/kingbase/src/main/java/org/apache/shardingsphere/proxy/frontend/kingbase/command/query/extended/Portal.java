...
package org.apache.shardingsphere.proxy.frontend.kingbase.command.query.extended;

import lombok.Getter;
import org.apache.shardingsphere.db.protocol.binary.BinaryCell;
import org.apache.shardingsphere.db.protocol.packet.DatabasePacket;
import org.apache.shardingsphere.db.protocol.kingbase.constant.PostgreSQLValueFormat;
...
import org.apache.shardingsphere.db.protocol.kingbase.packet.command.query.extended.bind.protocol.util.PostgreSQLTextBitUtils;
import org.apache.shardingsphere.db.protocol.kingbase.packet.command.query.extended.bind.protocol.util.PostgreSQLTextBoolUtils;
import org.apache.shardingsphere.db.protocol.kingbase.packet.command.query.extended.execute.PostgreSQLPortalSuspendedPacket;
...
public final class Portal {
    ...
    public Portal(final String name, final KingbaseServerPreparedStatement preparedStatement, final List<Object> params, final List<PostgreSQLValueFormat> resultFormats,
    ...
    private PostgreSQLIdentifierPacket createExecutionCompletedPacket(final boolean isSuspended, final int fetchedRows) {
        ...
        String sqlCommand = KingbaseCommand.valueOf(getSqlStatement().getClass()).map(KingbaseCommand::getTag).orElse("");
