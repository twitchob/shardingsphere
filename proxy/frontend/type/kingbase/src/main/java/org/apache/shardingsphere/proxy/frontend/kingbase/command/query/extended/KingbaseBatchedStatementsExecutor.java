...
import org.apache.shardingsphere.db.protocol.kingbase.packet.command.query.extended.bind.PostgreSQLTypeUnspecifiedSQLParameter;
 ...
 */
public final class KingbaseBatchedStatementsExecutor {
    ...
    private final KingbaseServerPreparedStatement preparedStatement;
    ...
    public KingbaseBatchedStatementsExecutor(final ConnectionSession connectionSession, final KingbaseServerPreparedStatement preparedStatement, final List<List<Object>> parameterSets) {
