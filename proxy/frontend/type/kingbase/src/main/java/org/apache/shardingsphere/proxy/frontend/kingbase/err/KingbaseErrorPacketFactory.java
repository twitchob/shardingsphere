...
package org.apache.shardingsphere.proxy.frontend.kingbase.err;

import com.google.common.base.Strings;
import lombok.AccessLevel;
import lombok.NoArgsConstructor;
import org.apache.shardingsphere.db.protocol.kingbase.constant.PostgreSQLMessageSeverityLevel;
import org.apache.shardingsphere.db.protocol.kingbase.packet.generic.PostgreSQLErrorResponsePacket;
...
public final class KingbaseErrorPacketFactory {
    
    private static final DatabaseType DATABASE_TYPE = TypedSPILoader.getService(DatabaseType.class, "Kingbase");
    ...
    public static PostgreSQLErrorResponsePacket newInstance(final Exception cause) {
        ...
        return serverErrorMessage.map(KingbaseErrorPacketFactory::createErrorResponsePacket)
