...
package org.apache.shardingsphere.proxy.frontend.kingbase.authentication;
...
import org.apache.shardingsphere.db.protocol.kingbase.constant.PostgreSQLAuthenticationMethod;
import org.apache.shardingsphere.db.protocol.kingbase.packet.generic.PostgreSQLReadyForQueryPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLAuthenticationOKPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLComStartupPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLParameterStatusPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLPasswordMessagePacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLRandomGenerator;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLSSLUnwillingPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.PostgreSQLSSLWillingPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.authentication.PostgreSQLMD5PasswordAuthenticationPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.handshake.authentication.PostgreSQLPasswordAuthenticationPacket;
import org.apache.shardingsphere.db.protocol.kingbase.packet.identifier.PostgreSQLIdentifierPacket;
...
import org.apache.shardingsphere.proxy.frontend.kingbase.authentication.authenticator.KingbaseAuthenticatorType;
 ...
 */
public final class KingbaseAuthenticationEngine implements AuthenticationEngine {
    ...
    private void login(final String databaseName, final String username, final byte[] md5Salt, final String digest, final AuthorityRule rule) {
        ...
        ShardingSpherePreconditions.checkState(new AuthenticatorFactory<>(KingbaseAuthenticatorType.class, rule).newInstance(user).authenticate(user, new Object[]{digest, md5Salt}),
    ...
    private PostgreSQLIdentifierPacket getIdentifierPacket(final String username, final AuthorityRule rule) {
        Optional<Authenticator> authenticator = rule.findUser(new Grantee(username)).map(optional -> new AuthenticatorFactory<>(KingbaseAuthenticatorType.class, rule).newInstance(optional));
